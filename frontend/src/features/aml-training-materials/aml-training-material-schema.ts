...
export const createAmlTrainingMaterialSchema = baseSchema.extend({
  document: z
...
export const updateAmlTrainingMaterialFormSchema = baseSchema.extend({
  document: z
...
export type CreateAmlTrainingMaterialSchemaValues = z.infer<typeof createAmlTrainingMaterialSchema>;
export type UpdateAmlTrainingMaterialSchemaValues = z.infer<typeof updateAmlTrainingMaterialFormSchema>;
