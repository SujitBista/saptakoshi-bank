...
export const createRiskTrainingMaterialSchema = baseSchema.extend({
  document: z
...
export const updateRiskTrainingMaterialFormSchema = baseSchema.extend({
  document: z
...
export type CreateRiskTrainingMaterialSchemaValues = z.infer<typeof createRiskTrainingMaterialSchema>;
export type UpdateRiskTrainingMaterialSchemaValues = z.infer<typeof updateRiskTrainingMaterialFormSchema>;
