...
export function PublicItTrainingMaterialsContent() {
  ...
  return (
    <PublicPortalLayout>
      <div className="mx-auto max-w-6xl">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-brand-blue">IT Training Materials</h1>
          <p className="mt-2 text-sm text-brand-black-75">
            View public IT training documents.
          </p>
        </div>

        <Card className="mb-6">
          <CardHeader title="Search IT Training Materials" description="Search by title" />
          <CardContent>
            <Input
              label="Search"
        ...
        <Card>
          <CardHeader
            title="IT Training Material List"
                    ...
                    <TableBody>
                      {materials.map((material) => (
                        <TableRow key={material.id}>
                          ...
                          <TableCell>{formatItTrainingMaterialDate(material.updatedAt)}</TableCell>
                          <TableCell>
                            <Link href={`/training-materials/it/view/${material.id}`}>
                ...
                <DataListCards className="md:hidden">
                  {materials.map((material) => (
                    ...
                    >
                      <DataListCardField
                        label="Updated"
                        value={formatItTrainingMaterialDate(material.updatedAt)}
                      />
                    </DataListCard>
                  ))}
                </DataListCards>
