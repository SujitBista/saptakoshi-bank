...
export const createItTrainingMaterialSchema = baseSchema.extend({
  document: z
...
export const updateItTrainingMaterialFormSchema = baseSchema.extend({
  document: z
...
export type CreateItTrainingMaterialSchemaValues = z.infer<typeof createItTrainingMaterialSchema>;
export type UpdateItTrainingMaterialSchemaValues = z.infer<typeof updateItTrainingMaterialFormSchema>;
