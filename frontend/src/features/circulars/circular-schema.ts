...
export const createCircularSchema = baseSchema.extend({
  document: z
...
export const updateCircularFormSchema = baseSchema.extend({
  document: z
...
export type CreateCircularSchemaValues = z.infer<typeof createCircularSchema>;
export type UpdateCircularSchemaValues = z.infer<typeof updateCircularFormSchema>;
