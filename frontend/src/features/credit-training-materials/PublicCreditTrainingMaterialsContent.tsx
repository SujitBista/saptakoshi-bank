...
export function PublicCreditTrainingMaterialsContent() {
  ...
  return (
    <PublicPortalLayout>
      <div className="mx-auto max-w-6xl">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-brand-blue">Credit Training Materials</h1>
          <p className="mt-2 text-sm text-brand-black-75">
            View public credit training documents.
          </p>
        </div>

        <Card className="mb-6">
          <CardHeader title="Search Credit Training Materials" description="Search by title" />
          <CardContent>
            <Input
              label="Search"
        ...
        <Card>
          <CardHeader
            title="Credit Training Material List"
                    ...
                    <TableBody>
                      {materials.map((material) => (
                        <TableRow key={material.id}>
                          ...
                          <TableCell>{formatCreditTrainingMaterialDate(material.updatedAt)}</TableCell>
                          <TableCell>
                            <Link href={`/training-materials/credit/view/${material.id}`}>
                ...
                <DataListCards className="md:hidden">
                  {materials.map((material) => (
                    ...
                    >
                      <DataListCardField
                        label="Updated"
                        value={formatCreditTrainingMaterialDate(material.updatedAt)}
                      />
                    </DataListCard>
                  ))}
                </DataListCards>
