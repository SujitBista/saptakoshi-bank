...
export function AdminCreditTrainingMaterialViewContent({ id }: { id: number }) {
      ...
      <div className="mx-auto max-w-6xl">
        {material ? (
          <div className="mb-4 flex justify-end gap-2">
            <Link href="/admin/training-materials/credit">
              <Button variant="outline">Back to List</Button>
            </Link>
            <Link href={`/admin/training-materials/credit/${material.id}/edit`}>
              <Button>Edit Credit Training Material</Button>
            </Link>
          </div>
        ) : null}
